...
echo "  /research [topic]   - Research keywords and competitors"
echo "  /write [topic]      - Write SEO-optimized article"
echo "  /humanize [file]    - Remove AI writing patterns"
echo "  /fact-check [file]  - Verify claims with web search"
echo "  /optimize [file]    - Final SEO optimization"
echo "  /data [type]        - Fetch performance data"
echo ""
